...
CREATE TABLE `LeaveRecord` (
  ...
  KEY `LeaveRecord_ibfk_1` (`student_id`),
  CONSTRAINT `LeaveRecord_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `Student` (`student_id`) ON DELETE CASCADE,
  CONSTRAINT `LeaveRecord_ibfk_2` FOREIGN KEY (`approved_by`) REFERENCES `User` (`user_id`)
